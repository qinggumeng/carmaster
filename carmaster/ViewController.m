...
- (void)simpleExampleTest {
    ...
    // 设置访问的URL
    NSURL *url = [NSURL URLWithString:@"http://www.hfbdqn.cn/car/uberpartner/HomePage.html"];
    // 根据URL创建请求
...
- (void)registerLocalNotification:(NSString *)alertTime alertBody:(NSString *)text{
    ...
    NSDate *fireDate =[dateFormat dateFromString:alertTime];
    ...
    // 通知参数
    NSDictionary *userDict = [NSDictionary dictionaryWithObject:text forKey:@"key"];
